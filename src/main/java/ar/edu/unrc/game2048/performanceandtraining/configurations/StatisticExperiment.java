 ...
 */
public abstract
class StatisticExperiment<NeuralNetworkClass> {
    ...
    void processFile(
        ...
        if (!logFile.exists()) {
            ...
            for (int i = 0; i < simulations; i++) {
                ...
                neuralNetworkInterfaceClone = (INeuralNetworkInterfaceFor2048<NeuralNetworkClass>) learningExperiment.getNeuralNetworkInterfaceFor2048()
                                                                                                                     .clone();
                ...
                if (learningExperiment.getNeuralNetworkInterfaceFor2048().getPerceptronConfiguration() != null) {
                    tempPerceptronConfiguration = (NeuralNetworkConfiguration2048<NeuralNetworkClass>) learningExperiment.getNeuralNetworkInterfaceFor2048()
