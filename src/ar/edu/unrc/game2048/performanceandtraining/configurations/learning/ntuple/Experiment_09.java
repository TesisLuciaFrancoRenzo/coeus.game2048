...
import ar.edu.unrc.game2048.performanceandtraining.configurations.ntuples.NIndividualScoreTanH;
...
//        boolean statistics = true;
    ...
    public void initialize() throws Exception {
        this.setTileToWin(256);
        if ( this.getExperimentName() == null ) {
            this.setExperimentName("Experiment_09");
        }
        this.setPerceptronName(this.getExperimentName());
        NTupleConfiguration2048 config = new NIndividualScoreTanH();
