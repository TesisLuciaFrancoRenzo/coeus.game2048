 ...
 * @author Franco
 */
public class BasicMaxTileLineal extends NTupleConfiguration2048 {
     ...
     *
     */
    public BasicMaxTileLineal() {
        this.activationFunction = FunctionUtils.lineal;
        this.derivatedActivationFunction = FunctionUtils.derivatedLineal;
