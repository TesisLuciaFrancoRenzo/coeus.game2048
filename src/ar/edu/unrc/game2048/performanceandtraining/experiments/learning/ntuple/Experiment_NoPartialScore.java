...
import ar.edu.unrc.game2048.performanceandtraining.configurations.ntuples.NBasicNoPartialScoreTanH;
 ...
 */
public class Experiment_NoPartialScore extends LearningExperiment<BasicNetwork> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LearningExperiment experiment = new Experiment_NoPartialScore();
...
//        boolean statistics = true;
    ...
    public void initialize() throws Exception {
        ...
        NTupleConfiguration2048 config = new NBasicNoPartialScoreTanH();
